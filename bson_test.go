...
var bsonTests = []struct {
	...
	{&struct{E float64 "e"}{2.71828}, []byte("\x10\x00\x00\x00\x01e\x00\x90\xf7\xaa\x95\t\xbf\x05@\x00")},
	...
	{&struct{S string "it's a"}{"string"}, []byte("\x18\x00\x00\x00\x02it's a\x00\x07\x00\x00\x00string\x00\x00")},
