...
var bsonTests = []bsonTest{
	...
	bsonTest{Doc{"test": &JavaScript{Code: "function foo(){};"}}, []byte("\x21\x00\x00\x00\x0Dtest\x00\x12\x00\x00\x00function foo(){};\x00\x00")},
	bsonTest{Doc{"test": Symbol("aSymbol")}, []byte("\x17\x00\x00\x00\x0Etest\x00\x08\x00\x00\x00aSymbol\x00\x00")},
	bsonTest{Doc{"test": &JavaScript{"function foo(){};", Doc{"hello": "world"}}}, []byte("\x3B\x00\x00\x00\x0Ftest\x00\x30\x00\x00\x00\x12\x00\x00\x00function foo(){};\x00\x16\x00\x00\x00\x02hello\x00\x06\x00\x00\x00world\x00\x00\x00")},
